...
echo color("red","|====================================|\n");
echo color("red","|      AUTO REGIST REDEEM GOJEK      |\n");
echo color("red","|====================================|\n");
echo color("red","| Claim Voucher Gojek                |\n");
echo color("red","| Auto Create Gojek X Redeem Voucher |\n");
echo color("red","| Github: indrael_                   |\n");
echo color("red","| Instagram : indrael_               |\n");
echo color("red","| Code By : indrael_ aka Dr. dre     |\n");
echo color("red","| Donate : 085335958998 |DANA|OVO|   |\n");
...
// function change(){
	...
	echo color("red","\n============(AUTO REGIST)=============\n");
        ...
        echo "\n".color("yellow","!] Claim Voc Chatime");
        echo "\n".color("yellow","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
        ...
        sleep(3);
        $boba10 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"CHATIME"}');
        ...
        sleep(3);
        $boba19 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"EATLAH"}');
        ...
        sleep(3);
        $goride = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"CENTURY"}');
